define([
	...
	return LevelModel.extend({
		...
		execute: function () {
			...
			this.get('SpeakerModel').say('Let\'s talk about Strings.')
			this.get('SpeakerModel').say('Strings are cool. Such as "wizard hat", "wand" and "spell book".')
