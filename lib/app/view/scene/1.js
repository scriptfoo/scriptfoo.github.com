...
], function (SceneView, PlayerEntityModel, TreeEntityModel, GrassEntityModel, CottageEntityModel, WeedEntityModel, ChestEntityModel, RuneEntityModel, FlowerEntityModel, BushEntityModel, FriarEntityModel, BearEntityModel, BunnyEntityModel, Villager1EntityModel, Villager2EntityModel) {
	return SceneView.extend({
		...
		addSceneEntities: function () {
			...
			new FriarEntityModel({
				...
				x: 530, y: 318,
				movements: [ 
					{x: 580, y: 300, delay: 800},
					{x: 620, y: 132, delay: 1300},
					{x: 420, y: 130, delay: 4300},
				] 
			});
			new FriarEntityModel({
				'sprite': 'IdleLeft',
